...
const Sidebar = () => {
  const menuItems = [
    ...
    { icon: FileText, label: 'Content Management', path: '/content', active: false },
    ...
    { icon: Image, label: 'Banner Management', path: '/banners', active: false },
    { icon: BarChart3, label: 'Reports and Analytics', path: '/reports', active: false },
